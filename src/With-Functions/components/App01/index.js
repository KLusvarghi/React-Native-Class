    ...
    <View style={styles.container}>
      ...
      <View>
        <View style={styles.containerMidias}>
          <TouchableOpacity  onPress={() => handleClick('https://github.com/KLusvarghi')} style={styles.social}>GitHub</TouchableOpacity >
          <TouchableOpacity  onPress={() => handleClick('https://www.linkedin.com/in/kaua-lusvarghi-422b141b4/')} style={styles.social}>Linkedin</TouchableOpacity >
        </View>
      </View>
